...
This project is indexed by GitNexus as **CyberPPT** (16147 symbols, 20113 relationships, 268 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/CyberPPT/context` | Codebase overview, check index freshness |
| `gitnexus://repo/CyberPPT/clusters` | All functional areas |
| `gitnexus://repo/CyberPPT/processes` | All execution flows |
| `gitnexus://repo/CyberPPT/process/{name}` | Step-by-step execution trace |
