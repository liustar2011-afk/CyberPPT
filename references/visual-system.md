...
- **线条**：主次线宽和颜色层级清楚，方向一致；端点准确落在对象边界，不悬空、不虚接、不穿越文字、数字或关键对象。虚线只表达反馈或弱关系，不作装饰。
- **边框**：使用细线和低对比色，避免厚框、重阴影和多层嵌套；同组内容保持一致的线宽、圆角和内边距。
- **箭头**：箭身细、箭头头小且贴近线端，方向一致，不穿越文字；编号、邻接或连续基线已经表达顺序时，减少重复箭头。禁止宽箭头带、发光箭头和厚重立体箭头。
- **形状**：同组形状保持尺寸、圆角、描边、材质和间距一致；避免无意义的挤出、发光、复杂阴影和过度立体效果，不限制业务所需的具体形态。
- **颜色角色**：深蓝表达主关系和结论，浅蓝灰承载辅助信息；暖色只标记风险、异常、限制、禁止或待处理状态，不为装饰随意增加颜色。
...
保持组件细节精确、干净、统一，不限制页面采用何种业务载体或构图。线条主次清楚、方向一致、端点准确，不悬空、不虚接、不穿越文字；虚线只表达反馈或弱关系。边框使用细线和低对比色，避免厚框、重阴影和多层嵌套，同组保持一致的线宽、圆角和内边距。箭身细、箭头头小且贴近线端，已有编号、邻接或连续基线时减少重复箭头，禁止宽箭头带、发光箭头和厚重立体箭头。形状保持尺寸、圆角、描边、材质和间距一致，避免无意义挤出、发光、复杂阴影和过度立体效果。色彩角色稳定，不为装饰随意增加颜色。
