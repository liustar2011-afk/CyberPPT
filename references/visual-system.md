...
面向政企领导汇报与演讲辅助场景，采用象牙白 #F7F6F0 与深蓝 #12355B，整体气质强调专业、克制、大气、稳重和可信度。其视觉身份为 senior leadership briefing / speech-support，不采用咨询交付件、学术论文、软件产品宣传或传统流程信息图的默认审美。

核心表达，不是流程说明，也不是技术结构展示，而是以具有行业语境的视觉表达承载业务能力、结果、价值和判断。画面强调单一主叙事中心，重点呈现“业务能力正在形成、协同、运行并产生作用”的状态，而不是泛化图表、抽象图标或技术名词的罗列。

其视觉基础以行业业务语境为主，可采用真实行业场景、场景化行业插画或编辑式行业插画，突出行业可信度、专业氛围和业务真实感。行业场景不是装饰，也不是独立海报，而是用于承载业务含义、能力关系和价值指向。整体风格弱化抽象科技感、互联网感和装饰性图形语言，避免 AI 芯片、抽象网络节点、科技蓝光、泛互联网技术场景、扁平图标主视觉、卡通化表达和抽象科技符号。

强调文图一体的叙事感，重视业务关系、能力层次、运行语境和价值路径的整体表达，不呈现软件架构图、技术规格图、中心模块加卫星节点、孤立生命周期环、泛化流程箭头、图标步骤图等视觉倾向；同时避免等权模块、编号步骤卡、时间线、机械流程模板、四栏咨询排版、卡片墙、SaaS/仪表盘以及库存会议照等常见表达方式。

图片中的人物不是主角，只能作为业务语境中的辅助元素存在，不承担主视觉，不承担核心判断表达，不形成宣传摄影或摆拍式人物中心画面，不出现人的正脸。
