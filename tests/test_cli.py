...
class CliTests(unittest.TestCase):
    ...
    def test_final_script_pages_requires_agent_relationship_judgment_before_generation(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
        ...
        self.assertIn("RELATIONSHIP_JUDGMENT_REQUIRED", buffer.getvalue())
