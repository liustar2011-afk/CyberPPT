...
行业公共能力
    ...
    服务对象：电力行业全国、区域、省级和重点行业供需形势预测与预警业务
    支撑机制：统一数据治理、组合模型、专家会商和成果生产共同支撑运转
    服务范围：覆盖全国、区域、省级和重点行业供需分析与预警成果输出

专业职责分工

    协同方式：与电网调度、市场出清和企业生产计划保持清晰的专业分工边界
    运行机制：统一口径、成果管理和跨区域跨部门协同，支持复盘和持续更新
