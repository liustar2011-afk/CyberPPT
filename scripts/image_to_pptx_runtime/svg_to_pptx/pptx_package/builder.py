    ...
    *,
    ...
    for master_part, slide_nums in slides_by_master.items():
        ...
        if promoted_master_xml is None:
            continue
        master_path.write_text(promoted_master_xml, encoding="utf-8", newline="\n")
...
def _create_cover_layout(extract_dir: Path, master_part: str, base_layout_part: str) -> str:
    ...
    new_layout_path.write_text(layout_xml, encoding="utf-8", newline="\n")
    ...
    new_rels_path.write_text(
        base_rels_path.read_text(encoding="utf-8"), encoding="utf-8", newline="\n"
    )
...
def _create_custom_layout(
    ...
    *,
    ...
    new_rels_path.write_text(rels_content, encoding="utf-8", newline="\n")
...
def _clone_master_theme(
    ...
    master_rels.write_text(rels_content, encoding="utf-8", newline="\n")
...
def _set_slide_layout_target(rels_path: Path, target: str) -> None:
    ...
    rels_path.write_text(new_content, encoding="utf-8", newline="\n")
    ...
    for key, slide_nums in families.items():
        ...
        if background_xml is not None:
            ...
            if updated_layout_xml is not None:
                layout_path.write_text(updated_layout_xml, encoding="utf-8", newline="\n")
                for slide_num in slide_nums:
                    slide_path = (
...
def _remove_content_type_override(content_types_path: Path, part_name: str) -> None:
    ...
    if removed:
        content_types_path.write_text(new_content, encoding="utf-8", newline="\n")
    ...
    *,
    ...
    for master_part in sorted(set(structure.slide_master_parts.values())):
        ...
        for rel_id, layout_part in sorted(layout_rels.items()):
            ...
            pruned += 1
        master_path.write_text(master_xml, encoding="utf-8", newline="\n")
    ...
    for parent in parents:
        ...
        for _ in range(3):
            ...
            try:
                ...
                probe_path.write_text("ok", encoding="utf-8", newline="\n")
                probe_path.unlink()
                return work_dir
            except OSError as exc:
...
def _ensure_notes_master(
    ...
    presentation_path.write_text(presentation_xml, encoding='utf-8', newline="\n")
  ...
  <Relationship Id="rId1"
                ...
                if audio_path:
                    ...
                    if use_narration_timings:
                        ...
                        package_uses_timings = True
                    slide_xml_path.write_text(slide_xml, encoding='utf-8', newline="\n")
