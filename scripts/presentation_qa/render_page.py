#!/usr/bin/env python3
"""One-shot render and structural QA for an exported PPTX page.
...
Usage:
    python3 scripts/presentation_qa/render_page.py path/to/deck.pptx --out-dir qa_render
"""
...
from scripts.presentation_qa.layout_qa import (  # noqa: E402
