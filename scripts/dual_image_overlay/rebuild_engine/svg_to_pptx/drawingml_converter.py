...
def convert_svg_to_slide_shapes(
    ...
    Args:
        ...
        asset_base_dir: Optional directory used to resolve relative external
            image hrefs when the SVG is converted from a temporary copy.
    ...
    ctx = ConvertContext(
        defs=defs,
        slide_num=slide_num,
        svg_dir=asset_base_dir or Path(svg_path).parent,
        merge_paragraphs=merge_paragraphs,
