    ...
    try:
        if PNG_RENDERER == 'cairosvg':
            cairosvg.svg2png(
                ...
                # unsafe=False (the default) silently drops local <image href="...">
                # raster references instead of erroring -- any SVG with an embedded
                # background/crop image would flatten to a blank PNG here.
                unsafe=True,
            )
            return True
