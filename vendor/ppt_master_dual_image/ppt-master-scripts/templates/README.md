...
The `charts/` directory contains standardized visualization templates. For backward compatibility, the directory name remains `charts/`, but its scope includes charts, infographics, process diagrams, relationship diagrams, strategic frameworks, and system architecture diagrams:
...
The `arrows/` directory contains reusable directional templates for slides where the arrow relationship is the main visual grammar, not a small icon:

- Connector arrows
- Chevron phase chains
- Long gradient strategy arrows
- Split / branch arrows
- Closed-loop feedback arrows
- Data-flow swimlanes
- Dotted support buses with upward taps
- Bottom foundation lift arrows
- Center bridge lift arrows for stacked architecture layers
- Side rail arrows for end-to-end coverage
- Local PPT gradient structure arrows (`pptpack*_gradient_*.svg`)

- **Library index**: [arrows/arrows_index.json](./arrows/arrows_index.json)
- **Usage rules**: [arrows/README.md](./arrows/README.md)

Selection priority for main slide arrows: use handcrafted structural templates
(`pptpack*_gradient_*`, `pptpack4_connector_route_*`, `block_*`, `*_bus_*`,
`*_lift_*`, etc.) for architecture grammar, action, cycle, and relationship
emphasis. Do not enlarge generic icon arrows into a page's primary visual
relationship, and do not add icon-library-derived arrows
to this template directory.
