...
class ConvertContext:
    ...
    # Selection-pane names must be unique enough for human editing. Shared by
    # child contexts so semantic duplicates become name_2/name_3 on the page.
    selection_name_counts: dict[str, int] = field(default_factory=dict)
    ...
    def child(
        ...
        return ConvertContext(
            ...
            selection_name_counts=self.selection_name_counts,
        )
