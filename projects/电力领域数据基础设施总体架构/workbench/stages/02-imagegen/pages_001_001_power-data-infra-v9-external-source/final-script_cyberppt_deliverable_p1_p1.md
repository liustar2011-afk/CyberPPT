...
【原文锁定规则｜最高优先级】
只允许使用上方锁定文字作为可见文案。逐字、完整并保持原有顺序呈现；不得改写、提炼、删减、合并、拆分、重排、重设标题或新增任何可见文字。
...
Render every supplied visible-text line verbatim, completely and exactly. Place the locked text beside, above, below or partially within its related business object or scene, so text and visual material form one local content unit. Do not rewrite, summarize, merge, split, reorder, relabel, or add visible copy.
