# power-supply-demand-forecast-0712
...
```bash
python3 -m cyberppt produce prepare power-supply-demand-forecast-0712 --pages <range>
python3 -m cyberppt produce assemble power-supply-demand-forecast-0712 --pages <range>
python3 -m cyberppt produce verify power-supply-demand-forecast-0712 --pages <range>
```
