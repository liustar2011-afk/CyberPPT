...
3. 还原：把已批准正文区蓝图晋升为经文字审计的 full 候选，盘点并重建为注册的可编辑 SVG 图层，再导出原生 PPTX；不得派生无字 background 或使用整页截图作为交付图层。
4. 交付：提供重建盘点、SVG 质量报告、PPTX、文字回读、全页渲染对照和 delivery readiness。任一关键门禁失败，不得交付确认。
