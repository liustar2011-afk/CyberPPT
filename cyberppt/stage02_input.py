...
def build_stage02_input(project: Path, *, script: Path) -> dict[str, Any]:
    ...
    binding: dict[str, Any] = {"scope":"project","path":INPUT_SCRIPT_PATH.as_posix(),"sha256":_sha256(snapshot),"semantic_sha256":_sha256(snapshot),"source_path":str(source)}
    if source.is_file(): binding["source_sha256"]=_sha256(source); binding["source_semantic_sha256"]=_sha256(source)
