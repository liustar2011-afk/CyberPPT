        ...
        pages.append(
            {
                ...
                "semantic_annotations": deepcopy(
                    visual.get("semantic_annotations") or {}
                ),
