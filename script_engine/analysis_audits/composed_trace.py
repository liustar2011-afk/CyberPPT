"""Triage Final Script wording against the existing Foundation source surface.

Adapted from addsumtech/slides_maker ``trace_composed.py`` at commit
0b38732543f62920f094a18c1621992068a18f57.  CJK n-grams distinguish
near-source wording from authored composition.  That distinction is a Critic
priority, never a fabrication verdict.  Exact source-absent numbers and
high-specificity Latin identifiers are the only hard findings.
"""
...
__all__ = [
    "cjk_ngrams", "latin_tokens", "numbers", "foundation_source_surface",
    "final_script_lines", "trace_composed", "critic_priorities", "hard_finding_messages",
]
