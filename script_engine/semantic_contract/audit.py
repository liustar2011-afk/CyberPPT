...
def audit_final_script_semantic_contract(
    ...
    payload, objective source boundaries, explicit PLAN onscreen composition and
    contract rules, and explicit visibility are the new semantic authority.
    During Phase 4, the historical Final Script auditor is invoked here as a
