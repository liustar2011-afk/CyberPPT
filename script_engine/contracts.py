...
_FOCUSED_EXPORTS = {
    ...
    "FIDELITY_TEXT_MAX_EFFECTIVE_CHARS": _fidelity_text.FIDELITY_TEXT_MAX_EFFECTIVE_CHARS,
    "FIDELITY_TEXT_MAX_ITEMS": _fidelity_text.FIDELITY_TEXT_MAX_ITEMS,
    "FIDELITY_VISIBILITY": _fidelity_text.FIDELITY_VISIBILITY,
    "canonicalize_fidelity_text": _fidelity_text.canonicalize_fidelity_text,
    "check_fidelity_text_contract": _fidelity_text.check_fidelity_text_contract,
